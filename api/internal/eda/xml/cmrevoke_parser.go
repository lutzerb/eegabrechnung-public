...
type CMRevokeDoc struct {
	MessageCode    string // "AUFHEBUNG_CCMS", "AUFHEBUNG_CCMS_IMP", or "AUFHEBUNG_CCMI"
...
func ParseCMRevoke(xmlStr string) (*CMRevokeDoc, error) {
	...
	return &CMRevokeDoc{
		...
		ReasonKey:      doc.ProcessDir.ReasonKey,
		Reason:         doc.ProcessDir.Reason,
	}, nil
}
